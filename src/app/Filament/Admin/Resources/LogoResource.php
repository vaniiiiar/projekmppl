        ...
        return $form
            ->schema([
                ...
                Forms\Components\FileUpload::make('image')
                    ...
                    ->image()
                    ->visibility('public') // agar bisa diakses langsung dari URL
                    ->preserveFilenames() // opsional, agar nama file tidak diacak
                    ->required(),
            ]);
    }
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\ImageColumn::make('image')
                    ->disk('public') // Sesuaikan dengan storage yang digunakan
                    ->label('Logo'),
