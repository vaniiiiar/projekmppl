      ...
      <div class="row align-items-center justify-content-center">
        <div class="col-lg-6 mb-5 mb-lg-0">
          <div class="block text-center text-lg-start pe-0 pe-xl-5">
            <h1 class="text-capitalize mb-4">Coffee Okan</h1>
            <p class="mb-4">Pengalaman Kopi Premium Indonesia Sejak 2024</p>
            <a href="#company-details" class="btn btn-primary">
              Profil Kami <span class="ms-2 fas fa-arrow-right"></span>
            </a>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="ps-lg-5 text-center">
            ...
            <div class="bg-white p-3 d-inline-block rounded shadow-sm">
              <img loading="lazy" decoding="async"
                ...
                alt="Logo Coffee Okan"
                class="img-fluid" style="max-height: 250px; width: auto;">
            </div>
          </div>
        </div>
      </div>
    </div>
    <!-- SVG Shapes sama seperti halaman home -->
  </section>


 <section class="section" id="company-details">
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="section-title pt-4">
            <p class="text-primary text-uppercase fw-bold mb-3">Profil Resmi</p>
            <h1 class="text-white">Identitas Perusahaan</h1> <!-- Added text-white class -->
          </div>
        </div>
