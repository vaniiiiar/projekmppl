...
<main>
<section class="banner bg-amber-800 position-relative overflow-hidden">
  <div class="container">
    <div class="row align-items-center justify-content-center">
      <div class="col-lg-6 mb-5 mb-lg-0">
        <div class="block text-center text-lg-start pe-0 pe-xl-5">
          <h1 class="text-capitalize mb-4 text-white">{{ $config->title ?? '' }}</h1>
            <p class="mb-4 text-white">{{ $config->detail ?? '' }}</p>
            <a class="btn btn-primary" href="{{ route('filament.customer.auth.login') }}"> 
              See More <span class="ms-2 fas fa-arrow-right"></span>
            </a>
          </div>
      </div>
      <div class="col-lg-6">
