...
<body>
    ...
    <section class="page-section clearfix">
        <div class="container">
            <div class="intro">
                <img class="intro-img img-fluid mb-3 mb-lg-0 rounded" src="{{ asset('assets/img/intro.jpg') }}" alt="Intro" />
    ...
    <footer class="footer text-faded text-center py-5">
        <div class="container"><p class="m-0 small">&copy; Your Website 2023</p></div>
    </footer>
